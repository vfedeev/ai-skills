...
def main():
    ...
    if env_path:
        ...
        print("\nOptions:")
        print("  1) Получить бесплатный ключ Groq (рекомендуется)")
        print("  2) Использовать OpenAI API (если есть ключ)")
        print("  3) Пропустить (настроить позже)")
        print("\n--- Как получить ключ Groq (бесплатно) ---")
        print("  1. Перейти на https://console.groq.com")
        print("  2. Зарегистрироваться (Google/GitHub/email)")
        print("  3. Перейти в API Keys: https://console.groq.com/keys")
        print("  4. Нажать 'Create API Key'")
        print("  5. Скопировать ключ и вставить ниже")
        print("  2) Использовать OpenAI API (если есть ключ)")
        print("  3) Пропустить (настроить позже)")
