...
def main():
    ...
    if env_path:
        ...
        print("\nOptions:")
        print("  1) Get free key at Groq (free, recommended)")
        print("  2) Use OpenAI API (if you have key)")
        print("  3) Skip for now (configure later)")
        print("\n--- How to get Groq API key (free) ---")
        print("  1. Go to https://console.groq.com")
        print("  2. Sign up with Google/GitHub/email")
        print("  3. Go to API Keys: https://console.groq.com/keys")
        print("  4. Click 'Create API Key'")
        print("  5. Copy the key and paste below")
        print("  2) Use OpenAI API (if you have key)")
        print("  3) Skip for now (configure later)")
